...
void main() {
      ...
      test(
        ...
        () async {
          ...
          await sut.request(
            url: url,
            method: "post",
            body: {'any_key': 'any_value'}, headers:{"any_header":"any_value"}
          );
  ...
  group("GET", () {
    ...
    test(
      'Should return NotFoundError if get return 404',
      () async {
        mockResponse(404, body: '');
  ...
  group(
    "PUT",
      ...
      test(
        'Should call put with correct values',
            () async {
          await sut.request(
            url: url,
            method: "put",
      ...
      test(
        'Should return data if put return 200',
            () async {
          final response = await sut
              .request(url: url, method: "put", body: {"EOQ": "EOAD"});
          expect(response, {"any_key": "any_value"});
        },
      );
    
      test(
        'Should return null if put return 200 wihtout data',
            () async {
          mockResponse(200, body: '');
      ...
      test(
        'Should return null if put return 204',
            () async {
          mockResponse(204, body: '');
      ...
      test(
        'Should return null if put return 204 with data',
            () async {
          mockResponse(204);
      ...
      test(
        'Should return BadRequestError if put return 400',
            () async {
          mockResponse(400);
      ...
      test(
        'Should return ServerError if put return 500',
            () async {
          mockResponse(500, body: '');
      ...
      test('Should return UnauthorizedError if put return 401', () async {
        mockResponse(401, body: '');
      ...
      test('Should return ForbiddenError if put return 403', () async {
        mockResponse(403, body: '');
      ...
      test(
        'Should return NotFoundError if put return 404',
            () async {
          mockResponse(404, body: '');
      ...
      test(
        'Should throw serverError if put throws',
            () async {
          mockError();
